...
class ReproductionMethods:
    ...
    def value_crossover(child: Genome, parent1: Genome, parent2: Genome,
                        ModifiedNEAT: list[NeatModule], source: list[NeatModule], epsilon=0.0):
        with torch.no_grad():
            ...
            for module_mod, module in zip(ModifiedNEAT, source):
    ...
    def binary_crossover(child: Genome, parent1: Genome, parent2: Genome,
                         ModifiedNEAT: list[NeatModule], source: list[NeatModule]):
        with torch.no_grad():
            if parent1.fitness > parent2.fitness:
                parent1, parent2 = parent1, parent2
            else:
