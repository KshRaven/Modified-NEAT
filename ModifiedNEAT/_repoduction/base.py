...
from ModifiedNEAT.nn.base import NeatModule #, bind_modules
from ModifiedNEAT.nn.genome import Genome, initialize_genome
...
class Reproduction:
    ...
    def create_new(self, pop_size: int, ModifiedNEAT: list[NeatModule]) -> dict[int, Genome]:
        # Create keys
        ...
        bind_modules(ModifiedNEAT, list(genomes.values()))
    ...
    def reproduce(self, species_set: SpeciesSet, population: dict[int, Genome], ModifiedNEAT: list[NeatModule], generation: int,
        ...
        bind_modules(ModifiedNEAT, list(population.values()), None)
